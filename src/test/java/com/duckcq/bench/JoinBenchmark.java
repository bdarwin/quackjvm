    ...
    public static void main(String[] args) {
        ...
        try (DuckDBDatabase database = DuckDBDatabase.builder().memoryLimit("512MB").build()) {
            ...
            report("hand-written join, on-heap", () -> {
                ...
                List<com.duckcq.query.JoinPair<Vehicle, Person>> pairs = new ArrayList<>();
                try (ResultSet<Vehicle> all = heapVehicles.retrieve(
                    ...
                    for (Vehicle vehicle : all) {
                        ...
                        if (person != null) {
                            pairs.add(new com.duckcq.query.JoinPair<>(vehicle, person));
                        }
                    }
                }
                return pairs.size();
            ...
            report("DuckDB join(), materialising pairs", () -> {
                try (java.util.stream.Stream<com.duckcq.query.JoinPair<Vehicle, Person>> pairs =
            ...
            report("DuckDB sql(), GROUP BY country", () -> {
                ...
                try (java.util.stream.Stream<com.duckcq.query.SqlRow> rows = database.sql(sql)) {
