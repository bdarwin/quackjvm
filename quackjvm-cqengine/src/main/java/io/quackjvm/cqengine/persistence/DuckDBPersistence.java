...
import io.quackjvm.cqengine.index.DuckDBIdentityIndex;
import io.quackjvm.cqengine.index.DuckDBTypeIndex;
import io.quackjvm.cqengine.internal.BlobRowCodec;
import io.quackjvm.cqengine.internal.ColumnarRowCodec;
import io.quackjvm.core.duckdb.ConnectionPool;
import io.quackjvm.cqengine.internal.IndexBulkTarget;
...
import io.quackjvm.cqengine.internal.RowCodec;
...
public class DuckDBPersistence<O, A extends Comparable<A>>
    ...
    /**
     * Called by each {@link io.quackjvm.cqengine.index.DuckDBIndex} as it initialises, so that
